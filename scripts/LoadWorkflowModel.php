...
class LoadWorkflowModel extends AbstractAction
{
    ...
    {
        if (count($params) < 1) {
            return new Report(ReportInterface::TYPE_ERROR, __('Usage: LoadWorkflowModel WORKFLOW_JSON'));
        }
        ...
        if (JSON_ERROR_NONE !== json_last_error()) {
            return new Report(ReportInterface::TYPE_ERROR, __('%s is not a valid JSON file', $file));
        }
        ...
        return new Report(ReportInterface::TYPE_SUCCESS, __('Successfully loaded model'));
    }
}
